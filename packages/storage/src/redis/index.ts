 ...
 * Uses environment variables from @healthcare-saas/env/server
 */
...
/**
 * Cache helper: Invalidate multiple keys by pattern
 */
export async function invalidateCachePattern(pattern: string): Promise<void> {
  ...
  // a more sophisticated key management strategy
  console.warn("invalidateCachePattern not fully implemented - use specific keys");
}
