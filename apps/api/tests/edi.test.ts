...
describe('EDI Integration', () => {
  ...
  it('should parse EDI 835 remittance', () => {
    const edi835 = `ISA*00*          *00*          *ZZ*HEALTHCARE*ZZ*BLUECROSS*240101*1200*^*12345*0*0*P*:
GS*HC*HEALTHCARE*BLUECROSS*240101*1200*12345*X*005010X221A1
ST*835*0001
CLP*CLM-001-000001*1*150.00*120.00*30.00
CAS*CO*45*30.00
SE*3*0001
GE*1*12345
IEA*1*12345`;
